...
import org.hannes.entity.sync.Animation;
import org.hannes.entity.sync.Appearance;
import org.hannes.entity.sync.ChatMessage;
import org.hannes.entity.sync.DamageIdentifier;
import org.hannes.entity.sync.Graphic;
import org.hannes.entity.sync.UpdateFlags;
import org.hannes.entity.sync.UpdateFlags.UpdateFlag;
import org.hannes.entity.sync.WalkingQueue;
import org.hannes.locale.Location;
import org.hannes.locale.Region;
import org.hannes.rs2.util.MovementFlags;
...
public abstract class Character extends Entity {
	 ...
	 */
	private Region lastUpdatedRegion = new Region(0, 0);
	...
	public Region getLastUpdatedRegion() {
		return lastUpdatedRegion;
	}

	public void setLastUpdatedRegion(Region lastUpdatedRegion) {
